...
class SupplierClass:
    def __init__(self, root):
        ...
        btn_add = Button(self.root, text="Add", font=("goudy old style", 15), bg="#2196f3", fg="white", command=self.add).place(x=180, y=340, width=120, height=35)
        btn_update = Button(self.root, text="Update", font=("goudy old style", 15), bg="#4caf50", fg="white", command=self.update).place(x=310, y=340, width=120, height=35)
        btn_delete = Button(self.root, text="Delete", font=("goudy old style", 15), bg="#f44336", fg="white", command=self.delete).place(x=440, y=340, width=120, height=35)
        btn_clear = Button(self.root, text="Clear", font=("goudy old style", 15), bg="#607d8b", fg="white", command=self.clear).place(x=570, y=340, width=120, height=35)
